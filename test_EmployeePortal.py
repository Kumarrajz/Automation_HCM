...
class TestDefaultSuite():
    ...
    def test_ActivateORDeactivateEmployeeCredentials(self,driver):
        ...
        driver.find_element(By.XPATH, "//span[contains(text(),'Activate/Deactivate Employee Credentials for the Employee Portal – HR Facing')]").click()
        elements = driver.find_elements(By.XPATH, "//body/app-root/app-full-layout[@class='ng-star-inserted']/div[@class='wrapper']/div[@class='main-panel']/div[@class='main-content']/div[@class='content-wrapper']/app-activate-deactivate[@class='ng-star-inserted']/div[@class='col-lg-12 col-md-12 col-sm-12']/div[@class='card']/div[1]")
    ...
    def test_Leave_Applications_Reviewal(self , driver):
        ...
        # driver.execute_script(windows.ScrollBy(0,500))
         ...
         driver.find_element(By.XPATH,"//span[contains(text(),'Leave Applications Reviewal (HR-Facing/Reporting M')]").click()
         elements =  driver.find_elements(By.XPATH, "//div[@class='card-header']")
         assert len(elements) > 0
         attach(data= driver.get_screenshot_as_png())
    ...
    def test_ApplyforAdvances (self,driver):
         ...
         actions = ActionChains( driver)
         actions.send_keys(Keys.PAGE_DOWN).perform()
         driver.find_element(By.XPATH, "//span[normalize-space()='Apply for Advances & Loans (Employee-Facing)']").click()
    ...
    def test_ReviewEmployeeAdvanceLoan(self,driver):
         ...
         actions = ActionChains( driver)
         actions.send_keys(Keys.PAGE_DOWN).perform()
         driver.find_element(By.XPATH, "//span[contains(text(),'Review Employee Advance & Loan Applications (HR-Facing)]").click(),"Error"
    ...
    def test_EnterAdvancesforEmployees (self,driver):
         ...
         elements =  driver.find_elements(By.XPATH, "//form[@class='ng-untouched ng-pristine ng-valid']//div[@class='card-header'][normalize-space()='Advances (HR-Facing)']"), "No Screen"
         assert len(elements) > 0
         attach(data= driver.get_screenshot_as_png())
    ...
    def test_Reimbursements (self,driver):
             ...
             elements =  driver.find_elements(By.XPATH, "//body/app-root/app-full-layout[@class='ng-star-inserted']/div[@class='wrapper']/div[@class='main-panel']/div[@class='main-content']/div[@class='content-wrapper']/app-reimbursements-management[@class='ng-star-inserted']/form[@class='ng-untouched ng-pristine ng-invalid']/div[1]/div[1]")
             assert len(elements) > 0
    ...
    def test_ReviewReimbursement  (self,driver):
                 ...
                 actions = ActionChains( driver)
                 actions.send_keys(Keys.PAGE_DOWN).perform()
                 driver.find_element(By.XPATH, "//span[normalize-space()='Review Reimbursement Applications (HR-Facing)']").click()
                 elements =  driver.find_elements(By.XPATH, "//body/app-root/app-full-layout[@class='ng-star-inserted']/div[@class='wrapper']/div[@class='main-panel']/div[@class='main-content']/div[@class='content-wrapper']/app-reporting-manager-review-of-reimbursement-application[@class='ng-star-inserted']/form[@class='ng-untouched ng-pristine ng-invalid']/div[1]/div[1]"), "No Screen"
                 assert len(elements) > 0
                 attach(data= driver.get_screenshot_as_png())
