...
class TestDefaultSuite():
    ...
    def test_calendermaster(self,driver):
        ...
        driver.find_element(By.XPATH,
                                 "/html[1]/body[1]/app-root[1]/app-full-layout[1]/div[1]/div[1]/app-sidebar[1]/div[2]/div[1]/ul[1]/li[1]/a[1]").click()
    ...
    def test_institutemaster(self,driver):
        ...
        driver.maximize_window()
        driver.find_element(By.XPATH,
                                 "//body/app-root/app-full-layout[@class=\'ng-star-inserted\']/div[@class=\'wrapper\']/div[@class=\'app-sidebar main-menu menu-fixed menu-native-scroll expanded ng-star-inserted\']/app-sidebar[@class=\'ng-tns-c154-3 ng-star-inserted\']/div[@class=\'sidebar-content main-menu-content ng-tns-c154-3 ps\']/div[@class=\'nav-container ng-tns-c154-3\']/ul[@class=\'navigation ng-tns-c154-3\']/li[1]/a[1]").click()
